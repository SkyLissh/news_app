...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(author: $author, title: $title, description: $description, url: $url, urlToImage: $urlToImage, content: $content, publishedAt: $publishedAt, source: $source)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, author, title, description, url,
      urlToImage, content, publishedAt, source);
